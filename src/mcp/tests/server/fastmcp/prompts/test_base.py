...
from mcp_grpc.server.fastmcp.prompts.base import AssistantMessage, Message, Prompt, TextContent, UserMessage
from mcp_grpc.types import EmbeddedResource, TextResourceContents
