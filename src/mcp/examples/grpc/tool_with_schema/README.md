# Running the MCP Tool With Schema Example with gRPC Transport

## Start The Server

```
blaze run  //third_party/py/mcp_grpc/examples/grpc/tool_with_schema:server \
...
```
blaze run  //third_party/py/mcp_grpc/examples/grpc/tool_with_schema:client \
