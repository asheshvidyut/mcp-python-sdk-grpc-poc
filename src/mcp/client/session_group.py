...
class ClientSessionGroup:
    ...
    @property
    def sessions(self) -> list[mcp_grpc.TransportSession]:
    ...
    async def disconnect_from_server(self, session: mcp_grpc.TransportSession) -> None:
    ...
    async def connect_with_session(
        self, server_info: types.Implementation, session: mcp_grpc.TransportSession
    ) -> mcp_grpc.TransportSession:
    ...
    async def _establish_session(
    ...
    ) -> tuple[types.Implementation, mcp_grpc.TransportSession]:
        ...
        try:
            ...
            if isinstance(server_params, StdioServerParameters):
                client = mcp_grpc.stdio_client(server_params)
            ...
            session = await session_stack.enter_async_context(mcp_grpc.ClientSession(read, write))
    ...
    async def _aggregate_components(self, server_info: types.Implementation, session: mcp_grpc.TransportSession) -> None:
        ...
        tool_to_session_temp: dict[str, mcp_grpc.TransportSession] = {}
