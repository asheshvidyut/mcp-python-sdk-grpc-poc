# Running the MCP Resource Template Example with gRPC Transport

## Start The Server

```
blaze run  //third_party/py/mcp_grpc/examples/grpc/resource_template:server \
...
```
blaze run  //third_party/py/mcp_grpc/examples/grpc/resource_template:client \
